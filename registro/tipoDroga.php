...
$message = '';
   ...
   $link = mysqli_connect("10.142.0.9", "redish", "5NZXdZm#@M7!", "registro_redish");
...
if (!empty($_POST['txt_Tipodroga'])){
$td=$_POST['txt_Tipodroga'];

      $sql = "INSERT INTO tipodroga (descripcion) VALUES ('$td');";
				    			...
				    			<div class="row">
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	...
										  	<input class="form-control" type="text" name="txt_Tipodroga" required="" maxlength="200">
										</div>
				    				</div>
				    			</div>
				    		</div>
